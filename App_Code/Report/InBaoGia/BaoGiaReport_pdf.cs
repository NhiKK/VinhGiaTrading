...
using System.Linq;
/// <summary>
/// Summary description for BaoGiaReport_pdf
/// </summary>
public class BaoGiaReport_pdf
{
    ...
    private HSSFWorkbook CreateHSSFWorkbook(DataTable dtDetails, DataTable dtDistinct, DataTable dtReferences)
    {
        ...
        s1.CreateRow(4).CreateCell(0).SetCellValue(dtDetails.Rows[0]["ten_cangbien"].ToString());
        ...
        cel.SetFont(f);
        s1.GetRow(4).GetCell(0).CellStyle = cel;
        ...
        s1.AddMergedRegion(new CellRangeAddress(4, 4, 0, 15));

        s1.CreateRow(5).CreateCell(0).SetCellValue("CUSTOMER NAME:");
		s1.GetRow(5).GetCell(0).CellStyle = cellBold;
		
        s1.GetRow(5).CreateCell(3).SetCellValue(dtDetails.Rows[0]["ten_dtkd"].ToString());
		s1.GetRow(5).GetCell(3).CellStyle = cellBold;


        s1.CreateRow(6).CreateCell(0).SetCellValue("ADDRESS:");
		s1.GetRow(6).GetCell(0).CellStyle = cellBold;
		
        s1.GetRow(6).CreateCell(3).SetCellValue(dtDetails.Rows[0]["diachi"].ToString() + " Tel:" + dtDetails.Rows[0]["tel"].ToString() + " Fax:" + dtDetails.Rows[0]["fax"].ToString());
		s1.GetRow(6).GetCell(3).CellStyle = cellBold;

        s1.GetRow(6).CreateCell(13).SetCellValue("Date:");
		s1.GetRow(6).GetCell(13).CellStyle = cellBold;
		
        s1.GetRow(6).CreateCell(14).SetCellValue(DateTime.Parse(dtDetails.Rows[0]["ngaybaogia"].ToString()).ToString("dd/MMM/yyyy"));
		s1.GetRow(6).GetCell(14).CellStyle = cellBold;	
		
        IRow headerColumn = s1.CreateRow(7);
        IRow headerColumn2 = s1.CreateRow(8);
        ...
        s1.AddMergedRegion(new CellRangeAddress(7, 8, 0, 0));

        headerColumn.GetCell(1).SetCellValue("Picture - Only for shape ref.");
        s1.AddMergedRegion(new CellRangeAddress(7, 8, 1, 1));

        headerColumn.GetCell(2).SetCellValue("Customer's Code");
        s1.AddMergedRegion(new CellRangeAddress(7, 8, 2, 2));

        headerColumn.GetCell(3).SetCellValue("Description");
        s1.AddMergedRegion(new CellRangeAddress(7, 8, 3, 3));

        headerColumn.GetCell(4).SetCellValue("Weight(" + tentl+")");
        s1.AddMergedRegion(new CellRangeAddress(7, 8, 4, 4));

        headerColumn.GetCell(5).SetCellValue("Packing");
        s1.AddMergedRegion(new CellRangeAddress(7, 7, 5, 6));
        ...
        s1.AddMergedRegion(new CellRangeAddress(7, 7, 7, 9));
        ...
        s1.AddMergedRegion(new CellRangeAddress(7, 7, 10, 12));
        ...
        s1.AddMergedRegion(new CellRangeAddress(7, 8, 13, 13));

        headerColumn.GetCell(14).SetCellValue("No. of master packages");
        s1.AddMergedRegion(new CellRangeAddress(7, 7, 14, 16));
        ...
        for (int i = 0; i < detailsCount; i++)
        {
            try
            {
                ...
                HSSFClientAnchor anchor = new HSSFClientAnchor(0, 0, 0, 0, 1, 9 + i, 2, 10 + i);
                //anchor.AnchorType = 2;
            ...
            s1.CreateRow(9 + i).CreateCell(0).SetCellValue(dtDetails.Rows[i]["msp"].ToString());
            s1.GetRow(9 + i).HeightInPoints = 50;
            s1.GetRow(9 + i).CreateCell(1).SetCellValue("");
            s1.GetRow(9 + i).CreateCell(2).SetCellValue(dtDetails.Rows[i]["ma_sanpham_khach"].ToString());
            s1.GetRow(9 + i).CreateCell(3).SetCellValue(dtDetails.Rows[i]["mota_tienganh"].ToString());
            s1.GetRow(9 + i).CreateCell(4).SetCellValue(double.Parse(dtDetails.Rows[i]["trongluong"].ToString()));
			// s1.GetRow(9 + i).CreateCell(4).SetCellType(CellType.FORMULA);
			// s1.GetRow(9 + i).GetCell(4).SetCellFormula("1 + H" + (10 + i));
            s1.GetRow(9 + i).GetCell(4).CellStyle = cellStyleRight;

            s1.GetRow(9 + i).CreateCell(5).SetCellValue(dtDetails.Rows[i]["sl_inner"].ToString());

            s1.GetRow(9 + i).CreateCell(6).SetCellValue(dtDetails.Rows[i]["master"].ToString());

            s1.GetRow(9 + i).CreateCell(7).SetCellValue(double.Parse((tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["l1"].ToString()) : double.Parse(dtDetails.Rows[i]["l1"].ToString()) / (double)2.54).ToString("#.0")));
            s1.GetRow(9 + i).GetCell(7).SetCellType(CellType.Numeric);

            s1.GetRow(9 + i).CreateCell(8).SetCellValue(double.Parse((tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["w1"].ToString()) : double.Parse(dtDetails.Rows[i]["w1"].ToString()) / (double)2.54).ToString("#.0")));
            s1.GetRow(9 + i).GetCell(8).SetCellType(CellType.Numeric);

            s1.GetRow(9 + i).CreateCell(9).SetCellValue(double.Parse((tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["h1"].ToString()) : double.Parse(dtDetails.Rows[i]["h1"].ToString()) / (double)2.54).ToString("#.0")));
            s1.GetRow(9 + i).GetCell(9).SetCellType(CellType.Numeric);
            
            s1.GetRow(9 + i).CreateCell(10).SetCellValue(double.Parse((tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["l2"].ToString()) : double.Parse(dtDetails.Rows[i]["l2"].ToString()) / (double)2.54).ToString("#.0")));
            s1.GetRow(9 + i).GetCell(10).SetCellType(CellType.Numeric);
            
            s1.GetRow(9 + i).CreateCell(11).SetCellValue(double.Parse((tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["w2"].ToString()) : double.Parse(dtDetails.Rows[i]["w2"].ToString()) / (double)2.54).ToString("#.0")));
            s1.GetRow(9 + i).GetCell(11).SetCellType(CellType.Numeric);
            
            s1.GetRow(9 + i).CreateCell(12).SetCellValue(double.Parse((tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["h2"].ToString()) : double.Parse(dtDetails.Rows[i]["h2"].ToString()) / (double)2.54).ToString("#.0")));
			s1.GetRow(9 + i).GetCell(12).SetCellType(CellType.Numeric);
			
            s1.GetRow(9 + i).CreateCell(13).SetCellValue(tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["v2"].ToString()) : double.Parse(dtDetails.Rows[i]["cbf"].ToString()));
            s1.GetRow(9 + i).GetCell(13).SetCellType(CellType.Numeric);
            
            s1.GetRow(9 + i).CreateCell(14).SetCellValue(double.Parse(dtDetails.Rows[i]["nopack_20"].ToString()));
            s1.GetRow(9 + i).GetCell(14).SetCellType(CellType.Numeric);
			
            s1.GetRow(9 + i).CreateCell(15).SetCellValue(double.Parse(dtDetails.Rows[i]["nopack"].ToString()));
            s1.GetRow(9 + i).GetCell(15).SetCellType(CellType.Numeric);

            s1.GetRow(9 + i).CreateCell(16).SetCellValue(double.Parse(dtDetails.Rows[i]["nopack_40hc"].ToString()));
            s1.GetRow(9 + i).GetCell(16).SetCellType(CellType.Numeric);
			
			s1.GetRow(9 + i).CreateCell(17).SetCellValue(double.Parse(dtDetails.Rows[i]["n_w_inner"].ToString()));
            s1.GetRow(9 + i).GetCell(17).SetCellType(CellType.Numeric);
			
			s1.GetRow(9 + i).CreateCell(18).SetCellValue(double.Parse(dtDetails.Rows[i]["g_w_inner"].ToString()));
            s1.GetRow(9 + i).GetCell(18).SetCellType(CellType.Numeric);
			
			s1.GetRow(9 + i).CreateCell(19).SetCellValue(double.Parse(dtDetails.Rows[i]["n_w_outer"].ToString()));
            s1.GetRow(9 + i).GetCell(19).SetCellType(CellType.Numeric);
			
			s1.GetRow(9 + i).CreateCell(20).SetCellValue(double.Parse(dtDetails.Rows[i]["g_w_outer"].ToString()));
            s1.GetRow(9 + i).GetCell(20).SetCellType(CellType.Numeric);
			
			s1.GetRow(9 + i).CreateCell(21).SetCellValue(double.Parse(dtDetails.Rows[i]["giafob"].ToString()));
            s1.GetRow(9 + i).GetCell(21).SetCellType(CellType.Numeric);
			s1.GetRow(9 + i).GetCell(21).CellStyle = cellNumBorder;
			
			s1.GetRow(9 + i).CreateCell(22).SetCellValue(dtDetails.Rows[i]["ten_cangbien"].ToString());
			s1.GetRow(9 + i).CreateCell(23).SetCellValue(double.Parse(dtDetails.Rows[i]["hscode"].ToString()));
			
			/*s1.GetRow(9 + i).CreateCell(24).SetCellValue(tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["l_cm"].ToString()) : double.Parse(dtDetails.Rows[i]["l_inch"].ToString()));	
			s1.GetRow(9 + i).CreateCell(25).SetCellValue(tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["w_cm"].ToString()) : double.Parse(dtDetails.Rows[i]["w_inch"].ToString()));
            s1.GetRow(9 + i).CreateCell(26).SetCellValue(tenkt.Equals("cm") ? double.Parse(dtDetails.Rows[i]["h_cm"].ToString()) : double.Parse(dtDetails.Rows[i]["h_inch"].ToString()));*/
        }
        ...
        for (int i = 0; i < dtDetails.Rows.Count; i++)
        {
            for (int j = 0; j <= 23; j++)
            {
                ...
                {
                    s1.GetRow(9 + i).GetCell(j).CellStyle = cellStyleRight;
                }
                else
                {
                    s1.GetRow(9 + i).GetCell(j).CellStyle = border;
					for(int nht = 7 ; nht <= 12; nht++)
					{
						s1.GetRow(9 + i).GetCell(nht).CellStyle = cellNumBorderKT;
					}
					s1.GetRow(9 + i).GetCell(13).CellStyle = cellNumBorderCBM;
					//s1.GetRow(8 + i).GetCell(15).CellStyle = cellNumBorder;
					s1.GetRow(9 + i).GetCell(18).CellStyle = cellNumBorder;
					s1.GetRow(9 + i).GetCell(20).CellStyle = cellNumBorder;
					s1.GetRow(9 + i).GetCell(21).CellStyle = cellNumBorder;
                }
            }
        }

        s1.CreateRow(10 + detailsCount).CreateCell(0).SetCellValue("Color References:");
        int curLine = 0;
        int lineNum = 4;
        int curCell = 0;
        int totalLine = 0;
        for (int i = 0; i < dtDistinct.Rows.Count; i++)
        {
            ...
            for (int j = 0; j < items.Count; j++)
            {
                ...
                {
                    s1.CreateRow(11 + detailsCount + curLine * 8 + i * 8);
                    s1.CreateRow(12 + detailsCount + curLine * 8 + i * 8);
                }

                if (j == 0 || j == items.Count)
                {
                    s1.GetRow(11 + detailsCount + curLine * 8 + i * 8).CreateCell(1).SetCellValue(items[j]["ta_ngan"].ToString());
                    s1.AddMergedRegion(new CellRangeAddress(11 + detailsCount + curLine * 8 + i * 8, 11 + detailsCount + curLine * 8 + i * 8, 1, 2));
                }


                s1.GetRow(11 + detailsCount + curLine * 8 + i * 8).CreateCell(4 + curCell * 3).SetCellValue("Color " + items[j]["codemau"].ToString());
                s1.GetRow(12 + detailsCount + curLine * 8 + i * 8).CreateCell(4 + curCell * 3).SetCellValue(items[j]["mau"].ToString());
                try
                {
                    String imgPath = Path.Combine(Public.imgColors, items[j]["url"].ToString());
                    System.Drawing.Image image = System.Drawing.Image.FromFile(imgPath);
                    MemoryStream ms = new MemoryStream();
                    image.Save(ms, System.Drawing.Imaging.ImageFormat.Jpeg);
                    ...
                    HSSFClientAnchor anchor = new HSSFClientAnchor(0, 0, 0, 0
                        , 4 + curCell * 3
                        , 13 + detailsCount + curLine * 8 + i * 8
                        , 6 + curCell * 3
                        , 19 + detailsCount + curLine * 8 + i * 8);
                    //anchor.AnchorType = 2;
       ...
       /* s1.CreateRow(totalLine * 8 + 10 + detailsCount).CreateCell(0).SetCellValue("Remark:");
        ...
        s1.GetRow(totalLine * 8 + 11 + detailsCount).CreateCell(1).SetCellValue("Other costs if occurring, will be charged to customers.");
        ...
        s1.GetRow(totalLine * 8 + 15 + detailsCount).CreateCell(1).SetCellValue(String.Format("{0} days after receipt of original L/C or 30% deposit", dtDetails.Rows[0]["shipmenttime"].ToString()));
        ...
        s1.GetRow(totalLine * 8 + 18 + detailsCount).CreateCell(1).SetCellValue(@"1. In favor VINH GIA COMPANY LTD. Account no. : 007.137.0321634 At bank: Joint Stock Commercial Bank For Foreign Trade of Vietnam (VIETCOMBANK),  29 Ben Chuong Duong St., Dist. 1, Hochiminh City, Vietnam. Tel: (84-28) 38297245, Fax: (84-28) 38297228, Swift code: BFTVVNVX007.");
        ...
        //s1.GetRow(totalLine * 8 + 16 + detailsCount).CreateCell(1).SetCellValue(dtDetails.Rows[0]["ten_cangbien"].ToString());
        s1.GetRow(totalLine * 8 + 22 + detailsCount).CreateCell(1).SetCellValue(String.Format("{0}", dtDetails.Rows[0]["ten_cangbien"].ToString()));
        ...
        s1.GetRow(totalLine * 8 + 24 + detailsCount).CreateCell(1).SetCellValue("In  favor VINH GIA COMPANY LIMITED"
    ...
    public BaoGiaReport_pdf(String c_baogia_id, String logoPath, String productImagePath)
	{
