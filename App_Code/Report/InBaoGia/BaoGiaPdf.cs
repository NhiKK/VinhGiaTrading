...
public class BaoGiaPdf
{
    ...
    private void CreatePDF(String fileName, DataTable dtDetails, DataTable dtDistinct, DataTable dtReferences, bool isForm)
    {
        ...
        try
        {
            ...
            Paragraph pAddress = new Paragraph("Northern Chu Lai Industrial Zone, Nui Thanh Commune, Danang City, Viet Nam", times_8);
            ...
            PdfPCell cellBank01 = new PdfPCell((new Phrase("1. In favor VINH GIA COMPANY LIMITED Account no. : 007.137.0321634 At bank: Joint Stock Commercial Bank For Foreign Trade of Vietnam (VIETCOMBANK),  29 Ben Chuong Duong St., Dist. 1, Hochiminh City, Vietnam. Tel: (84-28) 38297245, Fax: (84-28) 38297228, Swift code: BFTVVNVX007.", times_8)));
            cellBank01.Colspan = 2;
            tabFooter.AddCell(cellBank01);

            tabFooter.AddCell(new Phrase("", times_8));
            PdfPCell cellBank02 = new PdfPCell((new Phrase("2. In favor of VINH GIA COMPANY LIMITED Account no. : 001-395698-101 (USD). At bank: HSBC   Hochiminh City Branch , Metropolitan Building, 235 Dong Khoi St., Dist. 1, Tel.: (84-028) 35203051, Fax: (84-028) 38230530, Swift code: HSBCVNVXHochiminh City, Vietnam. ", times_8)));
